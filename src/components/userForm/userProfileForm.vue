    ...
    <b-form inline>
      <b-row>
        <b-col>
          <b-form-input id="input-1" class="mt-3 mr-sm-2 mb-sm-0" placeholder="UserName" type="text" required
            v-model="$v.user.name.$model" :state="validateState('name')"></b-form-input>
        ...
        <b-col>
          <b-input-group class="mt-3 mr-sm-2 mb-sm-0">
            <b-form-input id="input-2" type="number" placeholder="Contact No" required v-model="$v.user.contact.$model"
              :state="validateState('contact')"></b-form-input>
      ...
      <b-row>
        <b-col>
          <b-input-group class="mt-3 mr-sm-2 mb-sm-0">
            ...
            <b-form-invalid-feedback id="input-3-live-feedback" style="font-weight: bold">This field is required.
            </b-form-invalid-feedback>
          </b-input-group>
        </b-col>
        <b-col class="mt-5">
          ...
          <label class="radio-inline" style="margin: 2px">
            <input type="radio" name="gender" value="male" v-model="$v.user.gender.$model" />
            Male
          </label>
          <label class="radio-inline" style="margin: 2px">
            <input type="radio" name="gender" value="female" v-model="$v.user.gender.$model" />
            Female
          </label>
          <b-form-invalid-feedback id="input-4-live-feedback" style="font-weight: bold">Please select your gender.
          </b-form-invalid-feedback>
        </b-col>
      </b-row>
      ...
      <b-row>
        <b-col class="mt-3 mb-4">
          <b-button variant="primary" style="width: inherit" type="button" @click="addUserProfile"
            :disabled="$v.$invalid">
            Submit
          </b-button>
        </b-col>
  ...
  methods: {
    ...
    addUserProfile() {
      ...
      if (this.user.profilePic != null) {
        data.avatar = this.user.profilePic;
      }
