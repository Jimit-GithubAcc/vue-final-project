<template>
  <div>
    <b-button v-b-modal.modal-1 class="btn btn-warning" @click="uploadResume"
        ...
        <b-row class="mt-2 px-3">
          <b-col sm="12" xl="8" v-if="this.filelist.length" v-cloak>
            <b-list-group>
              ...
              >
                ...
                <!--file extension-->
                <span
                  class="d-inline-flex align-items-center text-muted ml-1 mr-3"
                  >.{{ filelist[i].extension }}</span
                >
          ...
          <b-col class="file-drop-column my-4 my-xl-0 p-0">
            ...
            >
              ...
              <label
                for="file-input"
                class="w-100 text-center cursor-pointer text-muted m-0 px-3 py-5"
              >
                <p>
                ...
                <div>
                  ...
                  <p class="mb-0">
                    or <span class="text-info">choose from computer</span>
                  </p>
                </div>
              </label>
            </div>
